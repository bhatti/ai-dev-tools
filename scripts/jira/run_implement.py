"""Run Claude to implement a Jira issue in the cloned repo.

Usage:
    python -m scripts.jira.run_implement --issue-id PROJ-42
...
1. Read CLAUDE.md, .cursorrules, .windsurfrules, or any repo-specific coding guidelines if they exist (one read, then proceed). Repo-local guidelines take precedence over global ones — never deviate from the existing language, style, and patterns.
