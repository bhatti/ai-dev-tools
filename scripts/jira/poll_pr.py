...
from scripts.jira.check_pr_state import main as check_pr_state_main
from scripts.jira.fetch_comments import main as fetch_comments_main
from scripts.jira.respond_comments import main as respond_comments_main
